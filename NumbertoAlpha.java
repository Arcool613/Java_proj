 ...
 * @author arnavkumar
 */
public class NumbertoAlpha extends javax.swing.JFrame {

    /**
     * Creates new form NumbertoAlpha
     */
    public NumbertoAlpha() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumbertoAlpha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NumbertoAlpha().setVisible(true);
            }
        });
    }
